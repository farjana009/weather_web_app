...
<head>
	<meta charset="utf-8">
	<title>Weather Web App :: Login Page</title>
		...
		<div class="panel panel-info">
			...
			<div style="padding-top:30px" class="panel-body">
				...
				if($this->session->flashdata('error')){
					...
					<div id="login-alert" class="alert alert-danger col-sm-12"><?php echo $this->session->flashdata('error'); ?></div>
					<?php
				}
				?>
				<form method="post" id="loginform" class="form-horizontal" role="form" action="<?php echo base_url('login/user_login')?>">

					<div style="margin-bottom: 25px" class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
						<input id="email_address" type="text" class="form-control" name="email_address" value=""
